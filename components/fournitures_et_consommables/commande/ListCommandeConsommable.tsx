import {
    ...
    return (
      <Container maxWidth="xl">
        <SectionNavigation direction="row" justifyContent="space-between" mb={2}>
          <Link href="/fourniteures_et_consommables/commande/ajouter">
  ...
  export default ListCommandeConsommable;
