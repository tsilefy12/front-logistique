...
export default function BonReceptionList() {
    ...
    const handleClickEdit = async (id: any) => {
        router.push(`/fournitures_et_consommables/bon_reception/${id}/edit`);
    };

    const handleClickDetails = async (id: any) => {
        router.push(`/fournitures_et_consommables/bon_reception/${id}/details`);
    };
    ...
    return (
        ...
        <NavigationContainer>
            <SectionNavigation>
            <Link href={"/fournitures_et_consommables/bon_reception/ajouter"}>
                        ...
                        {bonReceptions
                            ...
                            return (
                                <TableRow hover tabIndex={-1} key={row.id}>
                                    <TableCell align="left">{row?.bce}</TableCell>
