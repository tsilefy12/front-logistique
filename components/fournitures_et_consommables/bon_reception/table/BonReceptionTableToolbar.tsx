...
const BonReceptionTableToolbar = () => {
	const { loading } = useAppSelector((state) => state.bonReceptions)
...
export default BonReceptionTableToolbar;
