...
import TransportEquipmentTableToolbar from "./table/TransportEquipmentTableToolbar";
import TransportEquipmentTableHeader from "./table/TransportEquipmentTableHeader";
...
import { deleteTransportationEquipment, editTransportationEquipment } from "../../redux/features/transportation_equipment";
...
const ListTransport = () => {
	...
	const emptyRows =
		page > 0 ? Math.max(0, (1 + page) * rowsPerPage - transportationEquipments.length) : 0;
							...
							>
								...
								<TableBody>
									{transportationEquipments
										...
										.map((row: TransportationEquipmentItem | any, index : any) => {
