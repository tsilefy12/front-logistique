...
import { deleteConsumptionInvoice, getConsumptionInvoice } from "../../../redux/features/consumption_invoice";
  ...
  const ListFacture = () => {
    ...
    const emptyRows =
      page > 0
        ? Math.max(
            0,
            (1 + page) * rowsPerPage - consumptionInvoices.length
          )
        : 0;
                ...
                >
                  ...
                  <TableBody>
                    {consumptionInvoices
                      ...
                      .map(
                        (
                          row: ConsumptionInvoiceItem | any,
                          index: any
                        ) => {
