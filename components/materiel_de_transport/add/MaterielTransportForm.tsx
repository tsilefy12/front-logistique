...
import { createTransportEquipment, updateTransportationEquipment } from "../../../redux/features/transportation_equipment";
    ...
    <Container maxWidth="xl" sx={{ pb: 5 }}>
        <Formik
            ...
            initialValues={{
                ...
                otherInformation : isEditing ? transportationEquipment?.otherInformation : "",
            }}
            validationSchema={Yup.object({
                registration: Yup.string().required("Veuillez remplir le champ registration"),
                type: Yup.string().required("Veuillez remplir le champ type"),
                brand: Yup.string().required("Veuillez remplir le champ brand"),
                otherInformation: Yup.string().required("Veuillez remplir le champ otherInformation"),
            })}
                ...
                <Form>
                     <NavigationContainer>
                        <SectionNavigation>
                            ...
                            <Typography variant="h4">
                                { isEditing ? "Modifier" : "Ajouter"} un materiel de transport
                            </Typography>
                        </SectionNavigation>
                        <Divider />
                    </NavigationContainer>
                    ...
                    <FormContainer spacing={2}>
                        ...
                        <FormControl fullWidth>
                            <OSTextField id="outlined-basic" label="Type" variant="outlined" name = "type"/>
                        </FormControl>
                        <FormControl fullWidth>
                            <OSTextField id="outlined-basic" label="Marque" variant="outlined" name="brand"/>
                        </FormControl>
                        <FormControl fullWidth>
                            <OSTextField
                                id="outlined-basic"
