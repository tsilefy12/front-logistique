    ...
    <Container maxWidth="xl" sx={{ paddingBottom: 8 }}>
      <NavigationContainer>
        <SectionNavigation>
          ...
          <Typography variant="h4">Matériels de location externe</Typography>
        </SectionNavigation>
        {/* <Divider /> */}
      </NavigationContainer>
              ...
              >
                ...
                <TableBody>
                  {transportationEquipments
                    .filter((f) => f.status === "Location externe")
...
export default ListTransportExterne;
