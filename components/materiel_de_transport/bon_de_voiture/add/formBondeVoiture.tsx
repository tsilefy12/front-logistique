...
import { createCarVoucher, updateCarVoucher } from "../../../../redux/features/car-voucher";
    ...
    <Container maxWidth="xl" sx={{ pb: 5, mb: 4 }}>
        <Formik
            ...
            validationSchema={Yup.object({
                ...
                registration: Yup.string().required("Veuillez remplir le champ Immatriculation"),
                type: Yup.string().required("Veuillez remplir le champ Type"),
                reason: Yup.string().required("Veuillez remplir le champ Motif"),
                argument: Yup.string().required("Veuillez remplir le champ Argumentaire"),
                itinerary: Yup.string().required("Veuillez remplir le champ Itinéraire"),
                departureDate: Yup.string().required("Veuillez choisir le date de départ"),
                departureTime: Yup.string().required("Veuillez choisir heure de départ"),
                arrivalDate: Yup.string().required("Veuillez choisir le date de retour"),
                arrivalTime: Yup.string().required("Veuillez choisir heure de retour"),
                quantity: Yup.string().required("Veuillez remplir le champ Quantité"),
            })}
