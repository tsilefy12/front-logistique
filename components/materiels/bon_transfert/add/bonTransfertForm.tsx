...
import {
  createArticleTransfert,
  deleteArticleTransfert,
  updateArticleTransfert,
} from "../../../../redux/features/bon_transfert/articleTransfertSlice";
...
export default function BonTransfertForm() {
  ...
  const { isEditing, bonTransfert } = useAppSelector(
    (state) => state.bonTransfert
  );
      ...
      <Container maxWidth="xl" sx={{ paddingBottom: 8 }}>
        <Formik
          ...
          initialValues={{
            ...
            dateExp:
              isEditing && bonTransfert.dateExp
                ? new Date(bonTransfert.dateExp)
                : new Date(),
