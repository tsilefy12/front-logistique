                    ...
                    <View style={styles.table}>
                         <View style={{width: "100%" ,border:"1px solid #000",display: "flex",flexDirection: "row",}}>
                              <View style={{width: "50%" ,display: "flex",flexDirection: "column"}}>
                                   <Text style={{padding:2,fontSize:10,fontWeight:"bold"}}>Association Madagascar Voakajy</Text>
                                   <Text style={{padding:2,fontSize:10,fontWeight:"bold"}}>LOT IIF14P Bis A Andraisoro</Text>
                                   <Text style={{padding:2,fontSize:10}}>BP 5181,101 Antananrivo</Text>
                                   <Text style={{padding:2,fontSize:10}}>Contact: +261 34 25 155 23</Text>
                              </View>
                              <View style={{width: "50%",borderLeft:"1px solid #000",textAlign:"center",alignItems:"center",display: "flex",borderTop:"none",flexDirection: "column",padding:4}}>
                                   <Text style={{padding:2,fontSize:12}}>{pdfData?.fournisseur}</Text>
                                   <Text style={{padding:2,fontSize:12}}>Nif :{pdfData?.vendor?.nif}</Text>
                                   <Text style={{padding:2,fontSize:12}}>Stat:  {pdfData?.vendor?.website}</Text>
                              </View>
                         </View>
                    </View>
                    <View style={{width: "100%",marginTop:10}}>
                         <View style={{display:"flex",flexDirection:"row"}}>
                              <Text style={{width:"30%",fontSize:10,padding:4, height:20}}>Etabli le: {pdfData.establishmentDate ? format(new Date(pdfData.establishmentDate),"dd/MM/yyyy") :""}</Text>
                         </View>
                    </View>
