...
const BonCommandeFournisseurTableToolbar = () => {
	const { loading } = useAppSelector((state) => state.bonDeCommandeFournisseur)
...
export default BonCommandeFournisseurTableToolbar;
