...
const EquipmentStockTableToolbar = () => {
  const { loading } = useAppSelector((state) => state.equipmentStock);
...
export default EquipmentStockTableToolbar;
