...
export const getFile = createAsyncThunk("file/getFile", async (data: { imageUrl: any, args?: any }, thunkAPI) => {
    try {
        const params = {
            args: JSON.stringify(data.args),
        };
        const response = await axios.get(`${data.imageUrl}`, { params });
...
export const createFile = createAsyncThunk("file/createFile", async (data: FileItem, thunkAPI) => {
    try {
