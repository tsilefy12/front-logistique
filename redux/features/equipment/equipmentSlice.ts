...
import { getEquipment } from "./useCases/getEquipment";
...
export const equipmentSlice = createSlice({
  ...
  extraReducers: {
    ...
    [getEquipment.pending.type]: (state) => {
      state.loading = true;
    },
    [getEquipment.fulfilled.type]: (state, action) => {
      state.loading = false;
      state.equipment = action.payload;
    },
    [getEquipment.rejected.type]: (state, action) => {
      state.loading = false;
      state.error = action.error;
    },
    // edit equipment
